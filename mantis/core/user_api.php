...
function user_create( $p_username, $p_password, $p_email = '',
	...
	// phpbb_integration - Do not allow new user creation.
...
function user_signup( $p_username, $p_email = null ) {
	...
	// phpbb_integration - Do not allow new user signup.
	if (config_get('phpbb_integration') == ON) {
		return false;
	}
...
function user_delete( $p_user_id ) {
	...
	// phpbb_integration - Do not allow user deletions.
	if (config_get('phpbb_integration') == ON) {
		return false;
	}
...
function user_is_lost_password_request_allowed( $p_user_id ) {
	...
	// phpbb_integration - Do not allow requests for a lost password.
	if (config_get('phpbb_integration') == ON) {
		return false;
	}
...
function user_set_password( $p_user_id, $p_password, $p_allow_protected = false ) {
	...
	// phpbb_integration - Do not allow password changes.
	if (config_get('phpbb_integration') == ON) {
		return false;
	}
...
function user_set_email( $p_user_id, $p_email ) {
	...
	// phpbb_integration - Do not allow the user to set their email, as this is managed by phpbb.
	if (config_get('phpbb_integration') == ON) {
		return false;
	}
...
function user_reset_password( $p_user_id, $p_send_email = true ) {
	...
	// phpbb_integration - Do not allow the user to reset their password.
	if (config_get('phpbb_integration') == ON) {
		return false;
	}
